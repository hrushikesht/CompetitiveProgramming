    ...
    while(t--)
    {
        ...
        {   
            ...
            if(op==1)
            {
                ...
                ll ans=query(pos-1,mat-1,0,0,n-1);
                if(ans==0)
                {
                    cout<<"Lotsy"<<endl;
                }
            ...
            else
            {
                ...
                ll temp=findGrundy(s);
                // DEBUG(temp);
                // DEBUG(grundy[pos-1]);
                ll previous=grundy[pos-1];
                grundy[pos-1]=temp;

                // DEBUG(grundy[pos-1]);

                update(pos-1,previous^grundy[pos-1],0,0,n-1);
            }
            // cout<<endl;
        }
